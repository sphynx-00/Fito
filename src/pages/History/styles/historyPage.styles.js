...
export const title = { fontSize: 30, fontWeight: 700, letterSpacing: '-0.02em', color: 'var(--text-primary)' };

export const subtitle = { fontSize: 14, color: 'var(--text-muted)', marginTop: 2 };
