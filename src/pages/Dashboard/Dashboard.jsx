...
import { saveExerciseWeight } from "../../utils/exerciseUtils";
...
function Dashboard() {
  ...
  // ← permanent PR-style weight update, no more local exercises state
  const handleUpdateWeight = (order, newWeight) => {
    saveExerciseWeight(todaysWorkout.workoutId, order, newWeight);
